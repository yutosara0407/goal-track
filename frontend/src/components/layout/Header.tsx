...
import { Menu, X, Target, LayoutDashboard, ListTodo, CalendarDays, History, Rss, Users, Settings, LogOut } from 'lucide-react';
...
export function Header() {
  ...
  const navItems = [
    ...
    { href: '/timeline',  label: t.nav.timeline,  icon: <Rss size={20} /> },
